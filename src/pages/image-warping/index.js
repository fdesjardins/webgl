...
export const init = ({ camera, canvas, scene, uniforms, controls, mesh }) => {
  ...
  // ]
  let meshes = [
    add(scene, textureN, uniforms, 0, 0.04, 0, 0.0, vCoeffs, 0, 1, 1),
    add(scene, textureE, uniforms, -90, 0.01, 0, -0.0, vCoeffs, 0.1, 1.05, 0.96),
    add(scene, textureS, uniforms, -180, -0.0, 0, 0, vCoeffs, -0.2, 0.95, 1.1),
    add(scene, textureW, uniforms, -270, -0.025, 0, 0, vCoeffs, -0.1, 0.98, 1.1),
  ]
