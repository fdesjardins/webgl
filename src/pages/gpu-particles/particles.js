...
export const createTextures = ({ width, height }) => {
  ...
  const position = new THREE.DataTexture(posData, width, height, THREE.RGBAFormat, THREE.FloatType)
  const velocity = new THREE.DataTexture(velData, width, height, THREE.RGBAFormat, THREE.FloatType)
