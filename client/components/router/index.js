...
const HelloWorld = React.lazy(() => import('-/pages/examples/basics/hello-world'))
...
const LoadingObjects = React.lazy(() => import('-/pages/examples/basics/loading-objects'))
const HelloThreejs = React.lazy(() => import('-/pages/examples/threejs/hello-threejs'))
const PointLight = React.lazy(() => import('-/pages/examples/threejs/point-light'))
const GameOfLife = React.lazy(() => import('-/pages/examples/threejs/game-of-life'))
const VideoTexture = React.lazy(() => import('-/pages/examples/threejs/video-texture'))
const DrawingAxes = React.lazy(() => import('-/pages/examples/threejs/drawing-axes'))
const RayMarching = React.lazy(() => import('-/pages/examples/threejs/ray-marching'))
const HelloWebVr = React.lazy(() => import('-/pages/examples/threejswebvr/hello-threejswebvr'))
const VRInput = React.lazy(() => import('-/pages/examples/threejswebvr/vr-input'))
const ChildWorker = React.lazy(() => import('-/pages/examples/threejswebvr/worker'))
...
const OimoPhysics = React.lazy(() => import('-/pages/examples/threejs/oimophysics'))
const RayCasting = React.lazy(() => import('-/pages/examples/threejs/ray-casting'))
const TriangleStrip = React.lazy(() => import('-/pages/examples/threejs/triangle-strip'))
const FPSControls = React.lazy(() => import('-/pages/examples/threejs/first-person-controls'))
const DeviceOrientation = React.lazy(() =>
  import('-/pages/examples/threejs/device-orientation-controls')
)
const MarchingCubes = React.lazy(() => import('-/pages/examples/threejs/marching-cubes'))
const GpuCompute = React.lazy(() => import('-/pages/examples/threejs/gpu-compute'))
...
const StreamingPano = React.lazy(() => import('-/pages/examples/threejs/streaming-panorama'))
